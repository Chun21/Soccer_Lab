...
CFG_MODULE_PATH = SRC_ROOT / "tasks" / "direct" / "soccer_single_g1" / "soccer_single_g1_env_cfg.py"
...
def test_single_g1_motion_cfg_matches_policy_control_assumptions():
    ...
    cfg_mod = _load_module("Soccer_Lab.tasks.direct.soccer_single_g1.soccer_single_g1_env_cfg", CFG_MODULE_PATH)

    cfg = cfg_mod.SoccerSingleG1EnvCfg
    assert cfg.possible_agents == ["a1"]
